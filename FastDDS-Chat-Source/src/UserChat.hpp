...
#ifndef FAST_DDS_GENERATED__USERCHAT_HPP
#define FAST_DDS_GENERATED__USERCHAT_HPP
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(USERCHAT_SOURCE)
#define USERCHAT_DllAPI __declspec( dllexport )
#else
#define USERCHAT_DllAPI __declspec( dllimport )
#endif // USERCHAT_SOURCE
#else
#define USERCHAT_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define USERCHAT_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure UserChat defined by the user in the IDL file.
 * @ingroup UserChat
 */
class UserChat
{
public:
     ...
     */
    eProsima_user_DllExport UserChat()
    {
    }
     ...
     * @param x Reference to the object UserChat that will be copied.
     */
    eProsima_user_DllExport UserChat(
            const UserChat& x)
    {
     ...
     * @param x Reference to the object UserChat that will be copied.
     */
    eProsima_user_DllExport UserChat& operator =(
            const UserChat& x)
    {
     ...
     * @param x UserChat object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const UserChat& x) const
    {
...
#endif // _FAST_DDS_GENERATED_USERCHAT_HPP_
